      ...
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
            Discover a seamless learning experience tailored for your success.
            Join thousands of learners who trust Flowbite to elevate their
          ...
          <div className=" flex items-center gap-2.5">
           ...
           <p>
            <small>
                ...
                <Link href="/course" className=" text-green-500 px-2.5 font-bold">
                View Courses
                </Link>
            </small>
           </p>
        ...
        <div className=" lg:mt-0 lg:col-span-5 lg:flex">
          <Image src={phone} alt="mockup" width={600} height={400} />
        </div>
      </div>
    </section>
  );
